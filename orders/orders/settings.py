...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [
                (os.environ.get('REDIS_HOST', default='127.0.0.1'), int(os.environ.get('REDIS_PORT', default=6379)))
            ]
        }
    }
}
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('SQL_DATABASE', default=os.path.join(BASE_DIR, 'orders.db.sqlite3')),
